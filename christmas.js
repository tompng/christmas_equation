function christmasStarFunc(x,y,z){
  x*=3;
  y*=3;
  y=y-3.4;
  z*=2;
...
function christmasFunc(x,y,z){
  var tree=christmasTreeFunc(x,y,z);
  var star=christmasStarFunc(x,y,z);
  var deco=christmasDecoFunc(x,y,z);
